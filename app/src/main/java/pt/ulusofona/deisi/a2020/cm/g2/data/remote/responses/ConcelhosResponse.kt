package pt.ulusofona.deisi.a2020.cm.g2.data.remote.responses
...
data class ConcelhosResponse(
        ...
        @SerializedName("incidencia_categoria") val incidenciaCategoria: String,
        ...
        @SerializedName("tendencia_categoria") val tendenciaCategoria: String,
